...
public static class MeshGenerator {
    ...
    public static MeshData GenerateTerrainMesh(float[,] heightMap, MeshSettings meshSettings, int levelOfDetail) {
        ...
        int numVertsPerLine = meshSettings.numberOfVertsPerLine;
...
public class MeshData {
    ...
    public MeshData(int numVertsPerLine, int skipIncroment) {

        int numMeshEdgeVertices = (numVertsPerLine - 2) * 4 - 4;
        int numEdgeConnectionVertices = (skipIncroment - 1) * (numVertsPerLine - 5) / skipIncroment * 4;
        int numMainVerticesPerLine = (numVertsPerLine - 5) / skipIncroment + 1;
        int numMainVertices = numMainVerticesPerLine * numMainVerticesPerLine;

        vertices = new Vector3[numMeshEdgeVertices + numMainVertices + numEdgeConnectionVertices];
    ...
    Vector3[] CalculateNormals() {
        ...
        int borderedTriangleCount = outOfMeshTriangles.Length / 3;

        for (int i = 0; i < borderedTriangleCount; i++) {
